...
export default function App() {
  ...
  let onBlacklistedInsert = () => {
    /**
     * Invoke flutter to notify user and do any custom actions, e.g. show modal/tooltip
     */
    try {
      window.flutter_inappwebview.callHandler('onBlacklistedInsertHandler');
    } catch (err) {
      console.error('[CODOX][onBlacklistedInsert] flutter call error: ', err);
    }
  };
  ...
  const initLexicalConfig = useMemo(() => {
    ...
    return {
      ...
      onError: (error) => {
         ...
         *
         * Can call flutter here to notify flutter code
         */
