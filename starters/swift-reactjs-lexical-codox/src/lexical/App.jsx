...
export default function App() {
  ...
  const startCodoxSession = () => {
    ...
    const codoxConfig = {
      docId: 'swift_lexical_demo_docId', //this is the unique id used to distinguish different documents
      username: 'test_user', //unique user name
      apiKey: '8b1e21f3-6534-4877-9090-dbb9e61993eb', // apiKey provided by codox
      demo: true,
      hooks: {
